...
const Footer = () => {
  return (
  <footer className="bg-gray-100 text-gray-700 pt-20 lg:p-0  mt-20 mb-0 ">
  <div className="container mx-auto px-4 ">  
    <div className="relative   flex flex-col md:flex-row justify-between items-center bg-black p-6 rounded-2xl mb-10 text-white transform -translate-y-1/3 sm:-translate-y-1/2 md:-translate-y-1/2 lg:-translate-y-[40%]">
