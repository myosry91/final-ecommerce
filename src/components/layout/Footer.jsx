        ...
        <div className="flex flex-col md:flex-row justify-between items-start text-sm mb-10 -mt-20">
          <div className="w-full md:w-1/5 mr-16">
            ...
            <div className="flex my-4 space-x-4 sm:mb-5">
              <BsTwitter className="rounded-full border border-slate-300 p-1 text-black" size={28} />
              <BiLogoFacebook className="rounded-full bg-black border border-slate-300 p-1 text-white" size={28} />
              <BiLogoInstagram className="rounded-full border border-slate-300 p-1 text-black" size={28} />
              <BiLogoGithub className="rounded-full border border-slate-300 p-1 text-black" size={28} />
            </div>
          </div>
