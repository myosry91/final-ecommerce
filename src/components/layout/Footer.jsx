        ...
        <div className="relative  flex flex-col md:flex-row justify-between items-center bg-black p-6 rounded-2xl mb-10 text-white">
          ...
          <div className="flex flex-col gap-3 w-full md:w-1/3 mx-7">
            <div className="relative">
              <MdEmail
                className="absolute text-slate-300 top-5 left-5"
                size={20}
              />
              <input
                type="text"
            ...
            <button className="bg-white text-black px-3 py-3 rounded-[62px]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start text-sm mb-10 ">
          <div className="w-full md:w-1/5 mr-16">
            ...
            <div className="flex mt-4 space-x-4">
              <BiX
                className="rounded-full border border-slate-300 p-1 text-black"
                size={20}
              />
              <BiLogoFacebook
                className="rounded-full bg-black border border-slate-300 p-1 text-white"
                size={20}
              />
              <BiLogoInstagram
                className="rounded-full border border-slate-300 p-1 text-black"
